...
//  __android_log_print(ANDROID_LOG_INFO, "native", "setDestinations destPort=%p",fRTCPSocket);
//  __android_log_print(ANDROID_LOG_INFO, "native", "setDestinations isSSM()=%d",isSSM());
//  __android_log_print(ANDROID_LOG_INFO, "native", "setDestinations fMultiplexRTCPWithRTP=%d",fMultiplexRTCPWithRTP);
...
//    __android_log_print(ANDROID_LOG_INFO, "native", "fRTCPSocket destPort=%l",destPort);
  }
  Port destPort(serverPortNum+1);
  fRTCPSocket->changeDestinationParameters(destAddr, destPort, destTTL);
}
